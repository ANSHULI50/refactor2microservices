...
public class OrderDBConfiguration {
    ...
    @Bean
    @ConditionalOnProperty(name = "database.type", havingValue = "CQL")
    public CassandraOperations orderCassandraOperations(CqlSession cqlSession) throws Exception {
        return new CassandraTemplate(cqlSession);
    }

    @Bean
    @ConditionalOnProperty(name = "database.type", havingValue = "CQL")
    public CqlTemplate orderCqlTemplate(CqlSession cqlSession) throws Exception {
